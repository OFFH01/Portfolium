...
<nav class="navbar navbar-expand-lg navbar-dark bg-page">
  <div class="container-fluid">
    <a class="navbar-brand" href=""><img src="sys/libs/images/logo1.png" alt="" width="75" height="30"></a> <!--onclick="showview('Home')"-->
